            ...
            dynamic_mapping:
                ...
                suboptions:
                    ...
                    _intf_ip6_allowaccess:
                        ...
                        elements: str
                        description: Intf ip6 allowaccess.
                        choices: ['https', 'ping', 'ssh', 'snmp', 'http', 'telnet', 'any', 'fgfm',
                                  'capwap']
                    _intf_listen_forticlient_connection:
                        aliases: ['_intf_listen-forticlient-connection']
                        type: str
                    ...
                    broadcast_suppression:
                        ...
                        choices: ['dhcp', 'arp', 'dhcp2', 'arp2', 'netbios-ns', 'netbios-ds',
                    ...
                    portal_type:
                        ...
                        choices: ['auth', 'auth+disclaimer', 'disclaimer', 'email-collect',
                                  'cmcc', 'cmcc-macauth', 'auth-mac', 'external-auth',
                                  'external-macauth']
                    ...
                    rates_11a:
                        ...
                        choices: ['1', '1-basic', '2', '2-basic', '5.5', '5.5-basic', '6',
                                  '6-basic', '9', '9-basic', '12', '12-basic', '18', '18-basic',
                                  '24', '24-basic', '36', '36-basic', '48', '48-basic', '54',
                                  '54-basic', '11', '11-basic']
                    rates_11ac_ss12:
                        aliases: ['rates-11ac-ss12']
                        type: list
                        elements: str
                        description: Rates 11ac ss12.
                        choices: ['mcs0/1', 'mcs1/1', 'mcs2/1', 'mcs3/1', 'mcs4/1', 'mcs5/1',
                    ...
                    rates_11ac_ss34:
                        ...
                        choices: ['mcs0/3', 'mcs1/3', 'mcs2/3', 'mcs3/3', 'mcs4/3', 'mcs5/3',
                    ...
                    rates_11n_ss34:
                        ...
                        choices: ['mcs16/3', 'mcs17/3', 'mcs18/3', 'mcs19/3', 'mcs20/3',
                                  'mcs21/3', 'mcs22/3', 'mcs23/3', 'mcs24/4', 'mcs25/4',
                    ...
                    sae_groups:
                        ...
                        choices: ['1', '2', '5', '14', '15', '16', '17', '18', '19', '20', '21',
                                  '27', '28', '29', '30', '31']
                    sae_password:
                    ...
                    security:
                        ...
                        choices: ['None', 'WEP64', 'wep64', 'WEP128', 'wep128', 'WPA_PSK',
                                  ...
                                  'wpa-personal', 'wpa-enterprise', 'captive-portal',
                                  'wpa-only-personal', 'wpa-only-enterprise',
                                  'wpa2-only-personal', 'wpa2-only-enterprise',
                                  'wpa-personal+captive-portal',
                                  'wpa-only-personal+captive-portal',
                                  'wpa2-only-personal+captive-portal', 'osen', 'wpa3-enterprise',
                                  'sae', 'sae-transition', 'owe', 'wpa3-sae',
