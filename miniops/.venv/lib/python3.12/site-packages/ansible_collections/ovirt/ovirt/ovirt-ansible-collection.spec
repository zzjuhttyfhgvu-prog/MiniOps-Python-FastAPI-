...
Source0:	https://resources.ovirt.org/pub/src/ovirt-ansible-collection/ovirt-ansible-collection-3.2.2.tar.gz
...
Requires:	ansible-core >= 1:2.14.7-1
...
%changelog
* Tue Jan 6 2026 Jean-Louis Dupond <jean-louis@dupond.be> - 3.2.2-1
- Remove product type in engine_setup role as Red Hat Virtualization is no longer supported
- Rework hosted_engine_setup to support new ovirt-engine-appliance(s) builds
- Fix missing cluster name when starting VM

* Tue Jun 3 2025 Jean-Louis Dupond <jean-louis@dupond.be> - 3.2.1-1
- drop el8 support
- roles - Fix ansible-test errors change include to include_tasks
- ovirt_disk - fix documentation for lun_id parameter
- ovirt_proxied_check - fix documentation string
- Enable and start postfix service so that ovirt-ha-agent logs are not filled with mail notification errors
- Maintenance tasks regarding linting, testing and CI
