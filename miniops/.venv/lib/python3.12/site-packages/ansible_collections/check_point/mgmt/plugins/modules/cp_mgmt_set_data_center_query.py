...
DOCUMENTATION = """
---
module: cp_mgmt_set_data_center_query
short_description: Edits data-center-query objects on Checkpoint over Web Services API
description:
  - Edits data-center-query objects on Checkpoint devices.
...
RETURN = """
cp_mgmt_set_data_center_query:
  description: The checkpoint set-data-center-query output.
  returned: always.
  type: dict
"""
